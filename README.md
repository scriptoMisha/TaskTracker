...
Без npm, React и сборщиков — один `docker compose up` и через 30 секунд работающий UI.
...
3. **Деплой на бесплатный хостинг** (Railway или Fly.io) для живой демонстрации.
